...
<%@ page import="org.example.mytodo.model.Status" %><%--
...
<div class="container m-5 p-2 rounded mx-auto bg-light shadow">
                ...
                <div class="row bg-white rounded shadow-sm p-2 add-todo-wrapper align-items-center justify-content-center">
                    <div class="col">
                        <input class="form-control form-control-lg border-0 add-todo-input bg-transparent rounded"
                               type="text" name="title" placeholder="Add new .." required>
                    </div>
                    <div class="col-auto m-0 px-2 d-flex align-items-center">
                        <label class="text-secondary my-2 p-0 px-1 view-opt-label due-date-label d-none">Due date not
                            set</label>
                        <input type="datetime-local" name="created_date" class="form-control due-date-input"
                               data-toggle="tooltip"
    ...
    <div class="row px-3 align-items-center todo-item rounded">
        ...
        <div class="col-auto m-1 p-0 d-flex align-items-center">
            <a href="/finishedTodo?id=<%=todo.getId()%>">
                <h2 class="m-0 p-0">
        ...
        <div class="row px-3 align-items-center todo-item rounded">
            ...
            <div class="col px-1 m-1 d-flex align-items-center">
                <input type="text"
                       ...
                       readonly value="<%=todo.getTitle()%>" title="Renew car insurance"/>
            ...
            <div class="col-auto m-1 p-0 px-3">
                <div class="row">
                    <div class="col-auto d-flex align-items-center rounded bg-white border border-warning">
                        ...
                        <h6 class="text my-2 pr-2">CREATED DATE <%=todo.getCreateDate()%>
                        </h6>
                    </div>
                </div>
            </div>
            <div class="col-auto m-1 p-0 todo-actions">
                <div class="row d-flex align-items-center justify-content-end">
                    ...
                    <h5 class="m-0 p-0 px-2">
                        <a href="/deleteTodo?id=<%=todo.getId()%>" class="fa fa-trash-o text-danger btn m-0 p-0"
                           data-toggle="tooltip"
                           data-placement="bottom" title="Delete todo"></a>
                    </h5>
                </div>
                ...
                <div class="row todo-created-info">
                    <div class="col-auto d-flex align-items-center pr-2">
                        ...
                        <label class="date-label my-2 text-black-50">FINISHED DATE <%=todo.getFinishedDate()%>
                        </label>
                    </div>
                </div>
                <%}%>
